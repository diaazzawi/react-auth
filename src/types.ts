...
export type AuthKitStateInterfaceAuthToken<T> =
  | AuthKitStateInterfaceSignedIn<T>
  | AuthKitStateInterfaceSignedOut;
...
type AuthKitStateInterfaceRefresh =
  | AuthKitStateInterfaceWithRefresh
  | AuthKitStateInterfaceWithoutRefresh;

/**
 * Auth State Object
 */
export type AuthKitStateInterface<T> = AuthKitStateInterfaceAuthToken<T> &
  AuthKitStateInterfaceRefresh;

/**
 * Router Plugin for React Auth Kit
 * It's used to navigate between pages when needed by auth
 *
 */
